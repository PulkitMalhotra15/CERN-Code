...
void drawAODTheoretical(string graphType=""){
	...
	if(graphType=="bp"){
		...
		ampHist->Fill(getBP(60), fabs(angleOfDeviation(beam.proton, beam, mdx27, 60)));
		ampHist->Fill(getBP(120), fabs(angleOfDeviation(beam.proton, beam, mdx27, 120)));
		ampHist->Fill(getBP(180), fabs(angleOfDeviation(beam.proton, beam, mdx27, 180)));
		ampHist->Fill(getBP(240), fabs(angleOfDeviation(beam.proton, beam, mdx27, 240)));
